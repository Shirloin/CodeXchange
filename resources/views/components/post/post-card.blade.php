    ...
    <div class="w-full h-fit flex flex-col">
        <div class="flex justify-between mb-5">
            ...
            <div class="flex gap-6">
                ...
                <div class="h-fit rounded-full ring-1 ring-orange-400 text-orange-400 font-light px-8 py-1">
                    <p>Laravel</p>
                </div>
            </div>
        </div>
        <div class="w-full mb-5">
            <p class="font-medium text-sm text-ellipsis text-wrap line-clamp-2 truncate">Hello, I have X and
                Y component, in X
                component, I
                am dispatching
                event
