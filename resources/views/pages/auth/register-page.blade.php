        ...
        <form
            ...
            <div class="mb-4">
                ...
                <input class=" w-full pt-1 pb-2  bg-transparent border-b-2 border-grey-600 focus:outline-none focus:ring-0 "
                    placeholder="Enter Email" id="email" type="text">
            </div>
            <div class="mb-4">
                <label for="username">Username</label>
                <input class=" w-full pt-1 pb-2  bg-transparent border-b-2 border-grey-600 focus:outline-none focus:ring-0 "
                    placeholder="Enter Username" id="username" type="text">
            </div>
            <div class="mb-4">
            ...
            <button class="btn-blue-hover w-full rounded-md p-2 font-bold mt-4 mb-4">Register</button>
