        ...
        <form action="/register" method="POST"
            ...
            <div class="mb-4">
                ...
                <input class=" w-full pt-1 pb-2  bg-transparent border-b-2 border-grey-600 focus:outline-none focus:ring-0 "
                    placeholder="Enter Email" id="email" name="email" type="text" value={{old('email')}}>
            </div>
            <div class="mb-4">
                <label for="username">Username</label>
                <input class=" w-full pt-1 pb-2  bg-transparent border-b-2 border-grey-600 focus:outline-none focus:ring-0 "
                    placeholder="Enter Username" id="username" name="username" type="text" value={{old('username')}}>
            </div>
            <div class="mb-4">
                <label for="password">Password</label>
                <input class="w-full pt-1 pb-2  bg-transparent border-b-2 border-grey-600 focus:outline-none focus:ring-0  "
                    placeholder="Enter Password" id="password" name="password" type="password" value={{old('password')}}>
            </div>
