<div class="relative w-full mx-auto flex flex-grow justify-start lg:gap-x-10 px-6 xl:px-16 pt-10">
            ...
            <div class="flex px-6 py-4 lg:p-5">
                <div class="mr-5 hidden max-w-min text-left md:block">
                    <a class="relative flex items-start mb-2 rounded-lg w-20 h-20 p-0.5"
                        ...
                        <img class="relative w-20 h-20 rounded-lg" src={{ $post->user->image }} loading='lazy'
                            alt="">
                    </a>
